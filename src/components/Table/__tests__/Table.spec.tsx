    ...
    it("flattens the group into rows", () => {
      expect(
        ...
        },
        {
          ...
          path: JSON.stringify(["Chevrolet", "Camaro"]),
          label: "Camaro",
          depth: 1,
        },
        {
        ...
        },
        {
          ...
          path: JSON.stringify(["Cadillac", "Escalade EXT"]),
          label: "Escalade EXT",
          depth: 1,
        },
        {
        ...
        },
        {
          ...
          path: JSON.stringify(["Cadillac", "SRX"]),
          label: "SRX",
          depth: 1,
        },
        {
        ...
        },
        {
          ...
          path: JSON.stringify(["Ford", "Model T"]),
          label: "Model T",
          depth: 1,
        },
        {
